...
module Gritano::Core
  describe Repository do
    ...
    it "should be invalid without a path" do
      Repository.new(name: 'my_repo.git', owner_id: 1).should be_invalid
    end
    ...
    it "should have a unique name" do
      Repository.create(name: 'my_repo.git', path: 'path/to/some/folder', owner_id: 1)
      Repository.new(name: 'my_repo.git', path: 'path/to/some/folder', owner_id: 1).should be_invalid
    end
    ...
    it "should remove the bare repo when it is destroyed" do
      repo = Repository.create(name: 'my_repo.git', path: 'path/to/some/folder', owner_id: 1)
